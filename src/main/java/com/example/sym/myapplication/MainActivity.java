    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.bashedLine:
                ...
                break;
            case R.id.textViewDrawable:
                Intent drawableIntent = new Intent(this, TextViewDrawableActivity.class);
                startActivity(drawableIntent);
                break;
            case R.id.okHttpClient:
                Intent okHttpIntent = new Intent(this, OkHttpTestActivity.class);
                startActivity(okHttpIntent);
                break;
            case R.id.motionEvent:
                Intent motionEventIntent = new Intent(this, MotionEventActivity.class);
                startActivity(motionEventIntent);
                break;
